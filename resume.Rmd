...
- [`targets`](https://github.com/ropensci/targets), [`tarchetypes`](https://github.com/ropensci/tarchetypes), [`stantargets`](https://github.com/wlandau/stantargets), and [`drake`](https://github.com/ropesci/drake), R packages for reproducible computation and high-performance computing. [`drake`](https://github.com/ropesci/drake) is part of [rOpenSci](https://ropensci.org/).
