...
- [`stantargets`](https://github.com/wlandau/stantargets), Reproducible Bayesian data analysis pipelines with [`targets`](https://github.com/ropensci/targets) and [`cmdstanr`](https://github.com/stan-dev/cmdstanr). 
