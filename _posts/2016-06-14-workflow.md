...
In this case, <code>my_data <- ds(big_data, small_data)</code> is equivalent to <code>my_data <- ds(big_data, nrow = 6)</code>. More functionality like this is demonstrated in the <a href="https://github.com/wlandau/downsize/blob/master/README.md">README</a>.
</p>
