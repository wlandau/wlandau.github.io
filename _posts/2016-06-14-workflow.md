...
So these days, when I seriously analyze data in R, I like to bundle my
...
<a href="http://yihui.name/knitr/">knitr</a> is not the right tool for managing the entire workflow. For me, even a medium-sized project quickly becomes cumbersome when implemented as a <a href="http://yihui.name/knitr/">knitr</a> report from start to finish.
...
<li>Compile (<a href="http://yihui.name/knitr/">knitr</a>) reports.</li>
</ul>
