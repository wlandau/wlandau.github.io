...
frequently for tutorials and minimal working examples. However, when I implement a serious project with an overarching <a href="http://yihui.name/knitr/">knitr</a> report, my work quickly becomes cumbersome. Even with <a href="http://yihui.name/knitr/demo/externalization/">externalized code</a>,
...
To stay clean, organized, and modular, and to ensure that document compilation errors
do not interfere with the rest of the project, I usually separate the reports from the code. That brings me to the following reproducible build systems.
