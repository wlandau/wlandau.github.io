...
frequently for tutorials and minimal working examples. However, when I implement a serious project from start to finish with an overarching <a href="http://yihui.name/knitr/">knitr</a> report, the content of the analyses becomes tied up with the document, and my work quickly becomes cumbersome. 
