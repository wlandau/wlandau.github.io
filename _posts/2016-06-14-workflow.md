...
If you intersperse your code with calls to the <code>ds()</code> function in the <a href="https://github.com/wlandau/downsize">downsize</a> package, 
it is trivially easy to scale down or up. Say you want to analyze a large dataset.
