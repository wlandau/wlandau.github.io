...
countless times for tutorials, minimal working examples, graduate school homework assignments, code-intensive presentations, and other pedagogical tasks that require as much code as possible to be on display. However, when I implement a serious research project from start to finish with an overarching <a href="http://yihui.name/knitr/">knitr</a> report, the content of the analysis becomes too tied up with the document, and my work quickly becomes cumbersome. 
...
do not interfere with the rest of the project, I usually compartmentalize and separate reports, results, and code. Thus, I turn to other reproducible build systems.
