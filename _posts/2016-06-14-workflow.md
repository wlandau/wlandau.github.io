...
countless times for tutorials, minimal working examples, graduate school homework assignments, code-intensive presentations, and other tasks that require as much code as possible to be on display. However, when I implement a serious research project from start to finish with an overarching <a href="http://yihui.name/knitr/">knitr</a> report, the content of the analyses becomes too tied up with the document, and my work quickly becomes cumbersome. 
