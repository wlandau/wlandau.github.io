...
<code>scale_down()</code> or <code>scale_up()</code> at the very beginning. Thus,
tedium and human error are avoided, and the test provides a close approximation to the actual task at hand.
</p>
