...
frequently for tutorials and minimal working examples. However, when I implement a serious project from start to finish with an overarching <a href="http://yihui.name/knitr/">knitr</a> report, my work quickly becomes cumbersome. 
...
do not interfere with the rest of the project, I usually compartmentalize and separate reports and code. That brings me to the following reproducible build systems.
