...
dry run first. If you intersperse your code with enough calls to <a href="https://github.com/wlandau/downsize"><code>downsize::ds()</code></a>, 
...
The <code>ds()</code> function provides a choice between datasets.
...
You can toggle the global option <code>downsize</code> with a call to <code>scale_up()</code> or <code>downsize()</code> (same as <code>scale_down()</code>), and you can check the status with `scaling()`.
