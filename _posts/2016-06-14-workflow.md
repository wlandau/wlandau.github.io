...
To stay clean, organized, and modular, to allow for parallel computing, and to ensure that document compilation issues do not interfere with the rest of the project, I turn to other reproducible build systems.
...
I can just let <a href="https://github.com/richfitz/remake">remake</a>
